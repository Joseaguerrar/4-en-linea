...
class Tablero {
 public:
  ...
  void setvictoriasR(int n);
  void setvictoriasA(int n);
  // función para que el minimax pueda volver a tener su copia al estado
  // original en que se le pasó el tablero
  void quitarFicha();
  void mostrarTablero();
